	...
	settings: {
		...
		features: {
			...
			timeTracking: {
				...
				autoStopOtherName: "Эксклюзивное отслеживание времени",
				autoStopOtherDesc:
					"Одновременно можно отслеживать только одну задачу. При запуске нового сеанса текущий сеанс автоматически останавливается, а при редактировании прошлых записей перекрывающиеся записи корректируются для предотвращения пробелов и наложений.",
			},
			recurring: {
